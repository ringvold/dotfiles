...
source /home/harald/scripts/git-completion.bash

#### ALIAS ####

# open this
alias aalias='open /home/harald/.bashrc && source /home/harald/.bashrc'
...
# ssh to ec2 instance
alias sshec2='ssh -i ~/.ssh/webserver.pem harald@ringvold.nu'

# ssh to haraldringvold@domeneshop
alias sshds='ssh -i ~/.ssh/domshp haraldringvold@login.domeneshop.no'
...
# Gmote server
#alias startgmote ='sh /home/harald/.gmote/GmoteServer.sh'

# jdownloader
#alias jdownloader='sh /opt/jdownloader/jd.sh&'
